...
export const ServiceRow = ({ service, onActionClick }) => (
  <tr className="border-b hover:bg-gray-50 transition relative ">
...
export const ServicesTable = ({ services, onActionClick }) => (
  <div className="border-b bg-white hover:bg-green-50 transition cursor-pointer rounded-lg shadow-sm mb-1">
    <table className="w-full text-sm text-left text-gray-600">
      ...
      <tbody>
        {services.length > 0 ? (
          services.map((s) => (
            <ServiceRow key={s.id} service={s} onActionClick={onActionClick} />
          ))
        ) : (
          <tr>
